...
export function SettingsForm() {
  ...
  const totalePercentuale = RUOLI.reduce((sum, r) => sum + local.ruoli[r].percentualeBudget, 0);
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4">
      ...
      <p className={`text-xs mb-4 ${totalePercentuale === 100 ? "text-slate-400" : "text-amber-600"}`}>
        Totale percentuali: {totalePercentuale}% {totalePercentuale !== 100 && "(consigliato: 100%)"}
      </p>
